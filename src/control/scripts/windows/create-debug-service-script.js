                ...
                async.eachSeries([{
                    ...
                    function() {
                        ...
                        createFile(servicePath, shCalls, function(err) {
                            if (err) {
                                callback({
                                    message: 'Failed to create debug-service.bat for service ' + service.name
                                })
                            } else {
                                done();
                            }
...
function createFile(outputPath, shCalls, callback) {
    fs.writeFile(path.join(outputPath, 'debug-service.bat'), shCalls, callback);
}
